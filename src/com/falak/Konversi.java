...
public class Konversi {
   ...
   public static  double jdPukul(double julian_day){
    ...
    public  static double dmsKeDesimal(double derajat, double menit, double detik){
        if (derajat<0||menit<0||detik<0) return derajat-(Math.abs(menit)/60)-(Math.abs(detik)/3600);//Bila salah satu nilainya negatif
    ...
    public  static int [] desimalKeDms(double desimal){
        ...
        //ini pembulatan
        if ((int)detik>59){detik-=60; menit+=1;}
        if ((int)menit>59){menit-=60; derajat+=1;}
    ...
    public  static double [] desimalKeDmsMili(double desimal){
        ...
        if (detik>59.99){detik=0; menit+=1; }
        if ((int)menit>59){menit=0; derajat+=1;}
    ...
    public static String hmsMili(double desimal){
        if (desimal<0)      return "-"+(int) Konversi.desimalKeDmsMili(desimal)[1]+":"+(int) Konversi.desimalKeDmsMili(desimal)[2]+":"+String.format("%.2f", Konversi.desimalKeDmsMili(desimal)[3]);
        else return (int) Konversi.desimalKeDmsMili(desimal)[1]+":"+(int) Konversi.desimalKeDmsMili(desimal)[2]+":"+String.format("%.2f", Konversi.desimalKeDmsMili(desimal)[3]);
    }
    ...
    public  static String jd_kmString(double jd){
        ...
        return  namahari(nomor_hari)+", "+tanggal+" "+namaBulanMasehi(bulan)+" "+tahun;}
