...
public class Nutasi {
    ...
    public static double [] deltaPsiDanEpsilon(double t){
        double d=Math.toRadians((297.85036+445267.11148*t-0.0019142*t*t+t*t*t/189474)%360);
        double m=Math.toRadians((357.52772+35999.05034*t-0.0001603*t*t-t*t*t/300000)%360);
        double m1=Math.toRadians((134.96298+477198.867398*t+0.0086972*t*t+t*t*t/56250)%360);
        double f=Math.toRadians((93.27191+483202.017538*t-0.0036825*t*t+t*t*t/327270)%360);
